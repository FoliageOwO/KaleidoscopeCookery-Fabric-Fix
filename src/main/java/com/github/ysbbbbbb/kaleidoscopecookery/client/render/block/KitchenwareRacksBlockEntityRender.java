...
public class KitchenwareRacksBlockEntityRender implements BlockEntityRenderer<KitchenwareRacksBlockEntity, BlockEntityRenderState> {
    ...
    @Override
    public void extractRenderState(KitchenwareRacksBlockEntity racks, BlockEntityRenderState state, float partialTick, Vec3 cameraPos, ModelFeatureRenderer.CrumblingOverlay breakProgress) {
