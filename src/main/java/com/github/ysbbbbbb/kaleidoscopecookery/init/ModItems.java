...
public final class ModItems {
    private static Item.Properties itemProperties(String path) {
        return new Item.Properties().setId(ResourceKey.create(Registries.ITEM, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, path)));
    }

    // Block items
    public static final Item STOVE = new BlockItem(ModBlocks.STOVE, itemProperties("stove"));
    public static final Item POT = new BlockItem(ModBlocks.POT, itemProperties("pot"));
    public static final Item STOCKPOT = new BlockItem(ModBlocks.STOCKPOT, itemProperties("stockpot"));
    ...
    public static final Item OIL_BLOCK = new BlockItem(ModBlocks.OIL_BLOCK, itemProperties("oil_block"));
    public static final Item CHOPPING_BOARD = new BlockItem(ModBlocks.CHOPPING_BOARD, itemProperties("chopping_board"));
    public static final Item ENAMEL_BASIN = new BlockItem(ModBlocks.ENAMEL_BASIN, itemProperties("enamel_basin"));
    public static final Item KITCHENWARE_RACKS = new WithTooltipsBlockItem(ModBlocks.KITCHENWARE_RACKS, itemProperties("kitchenware_racks"), "kitchenware_racks");
    public static final Item CHILI_RISTRA = new BlockItem(ModBlocks.CHILI_RISTRA, itemProperties("chili_ristra"));
    public static final Item STRUNG_MUSHROOMS = new BlockItem(ModBlocks.STRUNG_MUSHROOMS, itemProperties("strung_mushrooms"));
    public static final Item STRAW_BLOCK = new BlockItem(ModBlocks.STRAW_BLOCK, itemProperties("straw_block"));
    public static final Item SHAWARMA_SPIT = new BlockItem(ModBlocks.SHAWARMA_SPIT, itemProperties("shawarma_spit"));
    public static final Item MILLSTONE = new BlockItem(ModBlocks.MILLSTONE, itemProperties("millstone"));
    public static final Item STEAMER = new SteamerItem(itemProperties("steamer"));
    public static final Item OIL_POT = new OilPotItem(itemProperties("oil_pot"));

    // Feast
    public static final Item COLD_CUT_HAM_SLICES = new LiftBlockItem(ModBlocks.COLD_CUT_HAM_SLICES, itemProperties("cold_cut_ham_slices"), "cold_cut_ham_slices");
    ...
    public static final Item STRAW_HAT = new StrawHatItem(itemProperties("straw_hat"), false);
    public static final Item STRAW_HAT_FLOWER = new StrawHatItem(itemProperties("straw_hat_flower"), true);
    public static final Item FARMER_CHEST_PLATE = new Item(itemProperties("farmer_chest_plate").stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER.value(), ArmorType.CHESTPLATE));
    public static final Item FARMER_LEGGINGS = new Item(itemProperties("farmer_leggings").stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER.value(), ArmorType.LEGGINGS));
    public static final Item FARMER_BOOTS = new Item(itemProperties("farmer_boots").stacksTo(1).humanoidArmor(ModArmorMaterials.FARMER.value(), ArmorType.BOOTS));
    public static final Item TRANSMUTATION_LUNCH_BAG = new TransmutationLunchBagItem(itemProperties("transmutation_lunch_bag"));

    // Seeds
    public static final Item TOMATO_SEED = new BlockItem(ModBlocks.TOMATO_CROP, itemProperties("tomato_seed"));
    public static final Item CHILI_SEED = new BlockItem(ModBlocks.CHILI_CROP, itemProperties("chili_seed"));
    public static final Item LETTUCE_SEED = new BlockItem(ModBlocks.LETTUCE_CROP, itemProperties("lettuce_seed"));
    public static final Item RICE_SEED = new RiceItem(itemProperties("rice"));
    public static final Item WILD_RICE_SEED = new BlockItem(ModBlocks.RICE_CROP, itemProperties("wild_rice"));

    // Cook stools
    public static final Item COOK_STOOL_OAK = new BlockItem(ModBlocks.COOK_STOOL_OAK, itemProperties("cook_stool_oak"));
    public static final Item COOK_STOOL_SPRUCE = new BlockItem(ModBlocks.COOK_STOOL_SPRUCE, itemProperties("cook_stool_spruce"));
    public static final Item COOK_STOOL_ACACIA = new BlockItem(ModBlocks.COOK_STOOL_ACACIA, itemProperties("cook_stool_acacia"));
    public static final Item COOK_STOOL_BAMBOO = new BlockItem(ModBlocks.COOK_STOOL_BAMBOO, itemProperties("cook_stool_bamboo"));
    public static final Item COOK_STOOL_BIRCH = new BlockItem(ModBlocks.COOK_STOOL_BIRCH, itemProperties("cook_stool_birch"));
    public static final Item COOK_STOOL_CHERRY = new BlockItem(ModBlocks.COOK_STOOL_CHERRY, itemProperties("cook_stool_cherry"));
    public static final Item COOK_STOOL_CRIMSON = new BlockItem(ModBlocks.COOK_STOOL_CRIMSON, itemProperties("cook_stool_crimson"));
    public static final Item COOK_STOOL_DARK_OAK = new BlockItem(ModBlocks.COOK_STOOL_DARK_OAK, itemProperties("cook_stool_dark_oak"));
    public static final Item COOK_STOOL_JUNGLE = new BlockItem(ModBlocks.COOK_STOOL_JUNGLE, itemProperties("cook_stool_jungle"));
    public static final Item COOK_STOOL_MANGROVE = new BlockItem(ModBlocks.COOK_STOOL_MANGROVE, itemProperties("cook_stool_mangrove"));
    public static final Item COOK_STOOL_WARPED = new BlockItem(ModBlocks.COOK_STOOL_WARPED, itemProperties("cook_stool_warped"));

    // Chairs
    public static final Item CHAIR_OAK = new BlockItem(ModBlocks.CHAIR_OAK, itemProperties("chair_oak"));
    public static final Item CHAIR_SPRUCE = new BlockItem(ModBlocks.CHAIR_SPRUCE, itemProperties("chair_spruce"));
    public static final Item CHAIR_ACACIA = new BlockItem(ModBlocks.CHAIR_ACACIA, itemProperties("chair_acacia"));
    public static final Item CHAIR_BAMBOO = new BlockItem(ModBlocks.CHAIR_BAMBOO, itemProperties("chair_bamboo"));
    public static final Item CHAIR_BIRCH = new BlockItem(ModBlocks.CHAIR_BIRCH, itemProperties("chair_birch"));
    public static final Item CHAIR_CHERRY = new BlockItem(ModBlocks.CHAIR_CHERRY, itemProperties("chair_cherry"));
    public static final Item CHAIR_CRIMSON = new BlockItem(ModBlocks.CHAIR_CRIMSON, itemProperties("chair_crimson"));
    public static final Item CHAIR_DARK_OAK = new BlockItem(ModBlocks.CHAIR_DARK_OAK, itemProperties("chair_dark_oak"));
    public static final Item CHAIR_JUNGLE = new BlockItem(ModBlocks.CHAIR_JUNGLE, itemProperties("chair_jungle"));
    public static final Item CHAIR_MANGROVE = new BlockItem(ModBlocks.CHAIR_MANGROVE, itemProperties("chair_mangrove"));
    public static final Item CHAIR_WARPED = new BlockItem(ModBlocks.CHAIR_WARPED, itemProperties("chair_warped"));

    // Tables
    public static final Item TABLE_OAK = new BlockItem(ModBlocks.TABLE_OAK, itemProperties("table_oak"));
    public static final Item TABLE_SPRUCE = new BlockItem(ModBlocks.TABLE_SPRUCE, itemProperties("table_spruce"));
    public static final Item TABLE_ACACIA = new BlockItem(ModBlocks.TABLE_ACACIA, itemProperties("table_acacia"));
    public static final Item TABLE_BAMBOO = new BlockItem(ModBlocks.TABLE_BAMBOO, itemProperties("table_bamboo"));
    public static final Item TABLE_BIRCH = new BlockItem(ModBlocks.TABLE_BIRCH, itemProperties("table_birch"));
    public static final Item TABLE_CHERRY = new BlockItem(ModBlocks.TABLE_CHERRY, itemProperties("table_cherry"));
    public static final Item TABLE_CRIMSON = new BlockItem(ModBlocks.TABLE_CRIMSON, itemProperties("table_crimson"));
    public static final Item TABLE_DARK_OAK = new BlockItem(ModBlocks.TABLE_DARK_OAK, itemProperties("table_dark_oak"));
    public static final Item TABLE_JUNGLE = new BlockItem(ModBlocks.TABLE_JUNGLE, itemProperties("table_jungle"));
    public static final Item TABLE_MANGROVE = new BlockItem(ModBlocks.TABLE_MANGROVE, itemProperties("table_mangrove"));
    public static final Item TABLE_WARPED = new BlockItem(ModBlocks.TABLE_WARPED, itemProperties("table_warped"));

    // Food items
    public static final Item TOMATO = new Item(itemProperties("tomato").food(ModFoods.TOMATO));
    ...
    public static final Item LETTUCE = new Item(itemProperties("lettuce").food(ModFoods.LETTUCE));
    public static final Item RICE_PANICLE = new Item(itemProperties("rice_panicle"));
    public static final Item CATERPILLAR = new WithTooltipsItem(itemProperties("caterpillar").food(ModFoods.CATERPILLAR), "caterpillar");
    public static final Item FRIED_EGG = new Item(itemProperties("fried_egg").food(ModFoods.FRIED_EGG));
    ...
    public static final Item DUMPLING = new BowlFoodOnlyItem(itemProperties("dumpling"), ModFoods.DUMPLING);
    ...
    public static final Item SASHIMI = new Item(itemProperties("sashimi").food(ModFoods.SASHIMI));
    public static final Item RAW_LAMB_CHOPS = new Item(itemProperties("raw_lamb_chops").food(ModFoods.RAW_LAMB_CHOPS));
    public static final Item RAW_COW_OFFAL = new Item(itemProperties("raw_cow_offal").food(ModFoods.RAW_COW_OFFAL));
    public static final Item RAW_PORK_BELLY = new Item(itemProperties("raw_pork_belly").food(ModFoods.RAW_PORK_BELLY));
    public static final Item RAW_DONKEY_MEAT = new Item(itemProperties("raw_donkey_meat").food(ModFoods.RAW_DONKEY_MEAT));
    public static final Item RAW_CUT_SMALL_MEATS = new Item(itemProperties("raw_cut_small_meats").food(ModFoods.RAW_CUT_SMALL_MEATS));
    public static final Item RAW_MEATBALL  = new Item(itemProperties("raw_meatball").food(ModFoods.RAW_MEATBALL));
    public static final Item COOKED_LAMB_CHOPS = new Item(itemProperties("cooked_lamb_chops").food(ModFoods.COOKED_LAMB_CHOPS));
    public static final Item COOKED_COW_OFFAL = new Item(itemProperties("cooked_cow_offal").food(ModFoods.COOKED_COW_OFFAL));
    public static final Item COOKED_PORK_BELLY = new Item(itemProperties("cooked_pork_belly").food(ModFoods.COOKED_PORK_BELLY));
    public static final Item COOKED_DONKEY_MEAT = new Item(itemProperties("cooked_donkey_meat").food(ModFoods.COOKED_DONKEY_MEAT));
    public static final Item COOKED_CUT_SMALL_MEATS = new Item(itemProperties("cooked_cut_small_meats").food(ModFoods.COOKED_CUT_SMALL_MEATS));
    public static final Item COOKED_MEATBALL  = new Item(itemProperties("cooked_meatball").food(ModFoods.COOKED_MEATBALL));
