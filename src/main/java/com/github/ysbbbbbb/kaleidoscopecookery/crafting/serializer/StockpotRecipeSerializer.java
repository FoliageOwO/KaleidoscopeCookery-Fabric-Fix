...
public class StockpotRecipeSerializer implements RecipeSerializer<StockpotRecipe> {
    ...
    public static final ResourceKey<Recipe<?>> EMPTY_ID = ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(KaleidoscopeCookery.MOD_ID, "stockpot/empty"));
